 ...
 * <br>主要画图的servlet控制类 
 * @Company: 
 * @Created on 2014-1-8 上午11:57:13 
 * @author 杨凯 
 */
@Controller
public class AuthCode {  
  ...
  @RequestMapping(value="/yzm.png*",method=RequestMethod.GET)
    ...
    // 设置验证码中的图片显示汉字  
    private String setWriteDate1(Graphics g) {  
        g.setFont(new Font("楷体", Font.BOLD, 20));  
